    ...
    <aside className="w-56 shrink-0 min-h-screen bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-gray-200 space-y-1">
        <Link
          ...
          className="flex items-center px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded transition-colors"
        >
          + Novo Galpão
        </Link>
        <button
          onClick={handleLogout}
          className="w-full text-left px-3 py-2 text-sm text-gray-400 hover:text-gray-900 hover:bg-gray-100 rounded transition-colors"
        >
          Sair
        </button>
      </div>
